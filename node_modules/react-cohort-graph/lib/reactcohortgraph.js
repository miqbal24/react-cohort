                ...
                var _loop2 = function _loop2(anotherKey) {
                    if (data[key].hasOwnProperty(anotherKey)) {
                        ...
                        cellData.isLabel = true;
	                        ...
	                        else	_this.store[key].push([cellData].concat(_toConsumableArray(data[key][anotherKey].map(function (value, index) {
		                            var _ref;
        ...
        var _loop3 = function _loop3(key) {
            ...
            if (_this.store.hasOwnProperty(key)) {
                ...
                cellData.label = labelPrefix + ' ' + 0;
								if (_this.store[key][0][1]) {
									cellData.label = 'New Users';;
								};
                ...
                largeRow.forEach(function (el, index) {
                    ...
                    var value = _this._sumOfColumnWithIndex(_this.store[key], index);
										var avgValue = Number.parseFloat(value / (_this.store[key].length - (index - 2))).toFixed(2);
										console.log(index);
                    ...
                    _this.headers[key].push((_this$headers$key$pus = {
                        ...
                        index: index,
                        type: key
                    }, _defineProperty(_this$headers$key$pus, VALUE, avgValue + ' Average'), _defineProperty(_this$headers$key$pus, 'valueFor', largeRow[0]), _defineProperty(_this$headers$key$pus, 'total', cellData.total), _defineProperty(_this$headers$key$pus, PERCENT, percent), _defineProperty(_this$headers$key$pus, 'color', _this._shadeCellWithColor(percent, _this.options.shadeColor)), _defineProperty(_this$headers$key$pus, 'label', labelPrefix + ' ' + (index - 2)), _this$headers$key$pus));
                });
            }
        };
    ...
    this._sumOfColumnWithIndex = function (arr, index) {
        ...
        arr.forEach(function (el) {
            try {
				...
				if (index===1) {
					return sum}
					else 	return Number.parseFloat(sum).toFixed(2);
    };
...
var BodyCell = exports.BodyCell = function BodyCell(props) {
		if (props.isTotal || props.isLabel) {
        ...
        renderValue(props)
		        ...
		        'div',
		        { style: _extends({}, (0, _styles.tableCell)(props.tableCellStyles), { backgroundColor: props.color }, props.style), title: '$' + props.value + ' revenue from the ' + props.total + ' users acquired on ' + props.valueFor + ' by day this day'},
		        renderValue(props)
    );
};
