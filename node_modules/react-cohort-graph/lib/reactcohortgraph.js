...
var BodyCell = exports.BodyCell = function BodyCell(props) {
    return _react2.default.createElement(
        'div',
        { style: _extends({}, (0, _styles.tableCell)(props.tableCellStyles), { backgroundColor: props.color }, props.style), title: '$' + props.value + ' revenue from the ' + props.total + ' users acquired on ' + props.valueFor },
        renderValue(props)
    );
};
